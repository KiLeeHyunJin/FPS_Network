...
using UnityEditor;
    ...
    public class UIDissolve : BaseMeshEffect
    {
        ...
        static Material GetMaterial(Shader shader, ColorMode color)
        {
        ...
        static Material GetOrGenerateMaterialVariant(Shader shader, ColorMode color)
        {
            if (!shader)
                return null;
        ...
        static string GetDefaultMaterialPath(Shader shader)
        {
